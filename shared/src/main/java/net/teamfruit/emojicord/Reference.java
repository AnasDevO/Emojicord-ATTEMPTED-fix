...
public class Reference {
	...
	public static final @Nonnull String NAME = "GoslingCord";
	...
	public static final @Nonnull String GUI_FACTORY = "net.teamfruit.emojicord.gui.config.ConfigGuiFactory";
		...
		public static final @Nonnull String EMOJI_GATEWAY = "https://raw.githubusercontent.com/AnasDevO/Emojicord-ATTEMPTED-fix/refs/heads/Re-patch/api.json";
