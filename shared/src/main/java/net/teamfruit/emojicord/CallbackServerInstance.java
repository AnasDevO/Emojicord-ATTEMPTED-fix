...
//        final UriHttpRequestHandlerMapper reqistry = new UriHttpRequestHandlerMapper();
        ...
        final HttpService httpService = new HttpService(httpproc, serverHandler);

        final DefaultBHttpServerConnectionFactory connFactory = DefaultBHttpServerConnectionFactory.builder()
                .build();
